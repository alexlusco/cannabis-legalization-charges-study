...
df <- read_csv("data/police-reported-cannabis-offences-robustness-check.csv") # includes "unspecified" drug impaired driving charges
...
gtsave(table1, "tables/robustness-check/charges_table_paired-rc.png")
gtsave(table2, "tables/robustness-check/dispositions_table_welchs-rc.png")
...
gtsave(table3, "tables/robustness-check/charges_punitiveness_all-rc.png")
